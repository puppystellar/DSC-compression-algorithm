...
tips: if image format is changed, shift in line 341
...
from shapeFinding2 import BGRtoYUV, new_represent, new_represent2
...
def Encode(dataset, mode):
    # dataset not been used in this func
    ...
    for f in os.listdir(input_dir):
        ...
        # print(len(format(pixel_size - 1, 'b')))
        # print('$'*50)
